...
export const THEMES: { [key: string]: ThemeStyle } = {
  ...
  cardClass: "bg-neutral-900/90 backdrop-blur-lg border border-amber-500/20 rounded-2xl shadow-2xl",
  textClass: "text-amber-100/90",
  accentClass: "text-amber-400",
  buttonClass: "bg-gradient-to-r from-amber-500 to-yellow-600 text-neutral-950 font-semibold hover:from-amber-400 hover:to-yellow-500",
